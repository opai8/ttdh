  ...
  <div class="lyear-layout-container">
    ...
    <aside class="lyear-layout-sidebar">
      ...
      <div id="logo" class="sidebar-header">
        <a href="/" target="_blank"><img src="/assets/img/logo-sidebar.png" alt="LyLme" title="返回首页" /></a>
      </div>
	...
	<div class="applyrow">' . $applyrows . '</div>';
        ...
        <div class="sidebar-footer">
          <p class="copyright">Copyright &copy; 2025 Powered by <br> <a href="https://ttdh.eu.org" target="_blank"><?php echo explode("-", $conf['title'])[0]; ?> </a></p>
        </div>
      </div>
    </aside>
    <!--End 左侧导航-->
