...
(3, 'apply', '0', '收录申请'),
(4, 'apply_gg', '<b>收录说明：</b><br>1. 禁止提交钓鱼弹窗站点<br>2. 申请收录请先添加本站友链<br>3. 填写网址后，可点击-自动获取-网站图标<br>4. 提交后请耐心等待,可加电报群了解申请进度<br>', '收录公告'),
(5, 'background', './assets/img/background.jpg', '背景图片'),
(6, 'title', '天天导航 - 最简单的福利导航', '网站标题'),
(7, 'cdnpublic', NULL, 'CDN地址'),
(8, 'copyright', 'Copyright ©2022 <a href=\"/\">天天导航</a>.  All Rights Reserved.', '版权代码'),
(9, 'description', '天天导航收录最全面的色情网站, 宅男宅女必备色情网站导航, 为狼友提供丰富多彩的色情影片以及黄色网站', '网站描述'),
(10, 'home-title', '<h2 class=\"title\">上网，从这里开始！</h2>', '首页标题'),
(11, 'icp', '', '备案号'),
(12, 'keywords', '天天导航,成人网站,成人视频,成人APP,成人漫画,成人小说,成人下载,成人论坛,成人导航,色情导航,福利导航,中文色情网站,亚洲成人导航,黄色网站导航,网址导航,色站导航,色情网址,黄色网站app,黄色导航,色情app,色情网站,成人app,成人视频app,成人短视频,成人快手,成人网站导航,色情片,色情直播,成人直播,草榴,大香蕉,抖阴,福利视频,富二代,黄瓜视频,免费福利,免费色情,茄子视频,青青草,情色导航,日本AV,色吧,色中色,丝瓜视频,小草莓,小姐姐,杏吧,性吧,69热,99热,avbobo,avnight,av网站,jav', '关键字'),
...
(1, '精品APP', '<svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#icon-qie00\"></use></svg>', 1, 1, 0),
(2, '在线视频', '<svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#icon-bili\"></use></svg>', 2, 1, 0),
(3, '福利导航', '<svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#icon-remen\"></use></svg>', 3, 1, 0),
(4, '吃瓜曝光', '<svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#icon-csdn\"></use></svg>', 4, 1, 0),
(5, '综合论坛', '<svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#icon-tu00\"></use></svg>', 5, 1, 0),
(6, '美图写真', '<svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#icon-iconfont\"></use></svg>', 6, 1, 0),
(7, '桃色小说', '<svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#icon-yunpan\"></use></svg>', 7, 1, 0),
(8, '动漫专区', '<svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#icon-jshunxiao\"></use></svg>', 8, 1, 0),
(9, '片商情报', '<svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#icon-youku\"></use></svg>', 9, 1, 0),
(10, '种子搜索', '<svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#icon-games00\"></use></svg>', 10, 1, 0),
(11, '实用工具', '<svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#icon-ai-tool\"></use></svg>', 11, 1, 0),
(12, '网站公告', '<svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#icon-gg00\"></use></svg>', 12, 1, 0);
...
(64, 'CdnJs', 5, 'https://cdnjs.com/', '<svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#icon-cdnjs\"></use></svg>', NULL, 10, 1, 0),
(65, '字节跳动CDN', 5, 'https://cdn.bytedance.com/', '<svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#icon-zjtd00\"></use></svg>', NULL, 10, 1, 0),
(66, 'Font Awesome', 5, 'https://fontawesome.com/icons?https://fontawesome.com/', '<svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#icon-font-awesome\"></use></svg>', NULL, 10, 1, 0),
(67, 'MSDN我告诉你', 5, 'https://msdn.itellyou.cn/', '<svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#icon-msdn00\"></use></svg>', NULL, 10, 1, 0),
(68, '腾讯云', 5, 'https://cloud.tencent.com/', '<svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#icon-qcloud00\"></use></svg>', NULL, 10, 1, 0),
(69, '阿里云', 5, 'https://www.aliyun.com/', '<svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#icon-alicloud00\"></use></svg>', NULL, 10, 1, 0),
(70, '4399小游戏', 6, 'http://www.4399.com/', '<svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#icon-439900\"></use></svg>', NULL, 10, 1, 0),
(71, '7k7k小游戏', 6, 'http://www.7k7k.com/', '<svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#icon-7k7k00\"></use></svg>', NULL, 10, 1, 0),
(72, '英雄联盟', 6, 'https://lol.qq.com/', '<svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#icon-lol00\"></use></svg>', NULL, 10, 1, 0),
(73, '永劫无间', 6, 'https://www.yjwujian.cn/', '<svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#icon-yjwj00\"></use></svg>', NULL, 10, 1, 0),
(74, 'STEAM', 6, 'https://store.steampowered.com/', '<svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#icon-steam00\"></use></svg>', NULL, 10, 1, 0),
(75, '王者荣耀', 6, 'https://pvp.qq.com/', '<svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#icon-wzry00\"></use></svg>', NULL, 10, 1, 0),
(76, '3DM GAME', 6, 'https://www.3dmgame.com/', '<svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#icon-games00\"></use></svg>', NULL, 10, 1, 0),
(77, '申请收录', 12, '/apply', '<svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#icon-sq00\"></use></svg>', NULL, 10, 1, 0),
(78, '电报交流', 12, 'https://t.me/ttdh_tg/', '<svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#icon-bing\"></use></svg>', NULL, 10, 1, 0),
(79, '官方主页', 12, 'https://ttdh.eu.org/', '<svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#icon-home00\"></use></svg>', NULL, 10, 1, 0),
(80, '项目地址', 12, 'https://github.com/opai8/ttdh', '<svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#icon-fk00\"></use></svg>', NULL, 10, 1, 0);
...
(1, '主页', 'https://www.ttdh.now.cc/', 0, 10),
(2, '电报', 'https://t.me/ttdh_tg/', 1, 10),
(3, '关于本站', '/about', 1, 10),
(4, '申请收录', '/apply', 1, 10);
