...
<div class="text">
        ...
        <h3>软件许可协议</h3>
        <div class="hr_8"></div>
        <p>尊敬的用户，感谢您使用天天导航页，希望本程序能给您在上网时提供方便的入口。
        </p>
        <div class="hr_8"></div>
        <p>
            天天导航页(LyLme Spage)（以下称“本程序”），由上云六零科技工作室（以下称“上云六零”）开发，致力于简洁高效无广告的上网导航和搜索入口，沉淀最具价值链接，全站无商业推广，简约而不简单。</p>
        <p>
